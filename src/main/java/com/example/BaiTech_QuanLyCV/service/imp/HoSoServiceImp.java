...
public class HoSoServiceImp implements HoSoService {
    ...
    public HoSoDTO save(HoSoDTO hoSoDTO) {
        NhanVien nhanVien=nhanVienRepository.findById(hoSoDTO.getIdNhanVien()).orElseThrow(() -> new ResourceNotfound("Không tồn tại nhan vien có id: "+hoSoDTO.getIdNhanVien()));
